...
export function SimpleAnimation(ctx, duration, on_end) {
...
export function AnimGroup(ctx, duration, on_end, members) {
...
export function MotionLine(ctx, duration, on_end, from, to, style) {
  SimpleAnimation.call(this, ctx, duration, on_end);
  this.from = from;
  this.to = to;
  this.style = style || {};
